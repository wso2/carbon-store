CREATE TABLE IF NOT EXISTS SOCIAL_COMMENTS ( id BIGINT NOT NULL AUTO_INCREMENT,body CLOB, payload_context_id VARCHAR(250),user_id VARCHAR(100), tenant_domain VARCHAR(100), likes TINYINT, unlikes TINYINT, timestamp VARCHAR(100), PRIMARY KEY (id));
