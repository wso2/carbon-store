...
/*    *//**
    ...
    private static boolean validateSignature(Signature signature, String keyStoreName, String keyStorePassword,
        ...
        try {
            ...
            try {
                validateSignatureHelper(cert, signature);
                isSigValid = true;
            } catch (ValidationException e) {
    ...
    /**
     * This method validates the signature of the Assertions
     *
     * @param resp             SAML Response
     ...
     */
    private static boolean validateAssertionValidityPeriod(Assertion assertion) {
     ...
     * @return validity
     */
    private static boolean validateAudienceRestriction(Assertion assertion, Properties properties) {
    ...
    private static void validateSignatureHelper(java.security.cert.X509Certificate cert, Signature signature)
     ...
     * @throws org.opensaml.xml.validation.ValidationException if the URI is invalid or doesn't resolve to the expected DOM node
     */
     ...
     * @throws org.opensaml.xml.validation.ValidationException if the signature contains ds:Object children
     */
