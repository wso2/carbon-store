...
public class SSOAgentCarbonX509Credential implements SSOAgentX509Credential {
    ...
    public SSOAgentCarbonX509Credential(int tenantId, String tenantDomain)
            throws StoreSSOCommonException {

        readCarbonX509Credentials(tenantId, tenantDomain);
    }

    protected void readCarbonX509Credentials(int tenantId, String tenantDomain) throws StoreSSOCommonException {
    ...
    private void handleException(String errorMessage, Throwable e) throws StoreSSOCommonException {
